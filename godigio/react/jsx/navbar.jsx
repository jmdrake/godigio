            ...
            <div className="navbar navbar-inverse navbar-static-top">
                ...
                <nav className="collapse navbar-collapse" role="navigation">
                    ...
                    <ul className="nav navbar-nav">
                        <li><a href="fanhub.html"><span className="glyphicon glyphicon-home"></span> Home</a></li>
                        <li style={{visibility:this.props.postbuttonvisibility}}>
                            <a href="#postModal" role="button" data-toggle="modal"><span className="glyphicon glyphicon-plus"></span> Post</a>
                        </li>
