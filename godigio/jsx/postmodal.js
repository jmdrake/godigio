        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "form",
                        { className: "form center-block", onSubmit: this.handleSubmit },
                        React.createElement(
                            "div",
                            { className: "form-group" },
                            React.createElement("textarea", { className: "form-control input-lg", autofocus: "", placeholder: "Latest update", onChange: this.updateText, value: this.state.text })
                        )
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "button",
                            { className: "btn btn-primary btn-sm", "data-dismiss": "modal", "aria-hidden": "true", onClick: this.postClick },
                            "Post"
                        ),
                        React.createElement(
                            "ul",
                            { className: "pull-left list-inline" },
                            React.createElement(
                                "li",
                                null,
                                React.createElement(
